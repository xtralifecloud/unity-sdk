...
namespace CotcSdk {
    ...
    public sealed partial class Gamer : PropertiesObject {
        ...
        public GamerAccountMethods Account {
            get { return (AccountInstance ?? (AccountInstance = new GamerAccountMethods(this))); }
        }
        ...
        public GamerAchievements Achievements {
            get { return (AchievementsInstance ?? (AchievementsInstance = new GamerAchievements(this))); }
        }
        ...
        public GamerBatches Batches {
            get { return (BatchesInstance ?? (BatchesInstance = new GamerBatches(this))); }
        }
        ...
        public GamerVfs GamerVfs {
            get { return (GamerVfsInstance ?? (GamerVfsInstance = new GamerVfs(this))); }
        }
        ...
        public GamerGodfather Godfather {
            get { return (GodfatherInstance ?? (GodfatherInstance = new GamerGodfather(this))); }
        }
        ...
        public GamerMatches Matches {
            get { return (MatchesInstance ?? (MatchesInstance = new GamerMatches(this))); }
        ...
        public GamerProfileMethods Profile {
            get { return (ProfileInstance ?? (ProfileInstance = new GamerProfileMethods(this))); }
        }
        ...
        public GamerProperties Properties {
            get { return (PropertiesInstance ?? (PropertiesInstance = new GamerProperties(this))); }
        }
        ...
        public GamerScores Scores {
            get { return (ScoresInstance ?? (ScoresInstance = new GamerScores(this))); }
        }
        ...
        public GamerStore Store {
            get { return (StoreInstance ?? (StoreInstance = new GamerStore(this))); }
        }
        ...
        public GamerTransactions Transactions {
            get { return (TransactionsInstance ?? (TransactionsInstance = new GamerTransactions(this))); }
        }
        ...
        private GamerAccountMethods AccountInstance;
        ...
        private GamerProfileMethods ProfileInstance;
        private GamerProperties PropertiesInstance;
        private GamerScores ScoresInstance;
        private GamerStore StoreInstance;
        private GamerTransactions TransactionsInstance;
        #endregion
    }
}
